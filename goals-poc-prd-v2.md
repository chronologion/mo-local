...
- Sync scheduling is reactive and bounded: long-poll pull runs as a single loop, push is event-driven with debounced invalidation signals, and both directions apply capped exponential backoff with jitter under error conditions.
- **BC wiring**:
